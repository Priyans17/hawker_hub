...
class HawkerModel {
  ...
  factory HawkerModel.fromJson(Map<String, dynamic> json) {
    return HawkerModel(
      ...
      businessPhotos:
          json['business_photos'] != null
              ? List<String>.from(json['business_photos'])
              : null,
      ...
      reviews:
          json['reviews'] != null
              ? (json['reviews'] as List)
                  .map((review) => HawkerReview.fromJson(review))
                  .toList()
              : null,
  ...
  static List<HawkerModel> getMockHawkers() {
    return [
      HawkerModel(
        ...
        description:
            'Selling fresh fruits and vegetables directly from farms in Himachal Pradesh.',
      ...
      HawkerModel(
        ...
        description:
            'Organic vegetables grown in our own farms. No pesticides used.',
      ...
      HawkerModel(
        ...
        categories: ['fruit'],
        description:
            'Premium quality fruits imported from various countries. Exotic varieties available.',
      ...
      HawkerModel(
        ...
        description:
            'Certified organic produce. Farm to table concept with same-day harvesting.',
      ...
      HawkerModel(
        ...
        categories: ['fruit'],
        description:
            'Seasonal fruits at affordable prices. Special discounts for bulk orders.',
